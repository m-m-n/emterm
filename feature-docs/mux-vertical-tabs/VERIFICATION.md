...
| FR5 | task0003, task0005, task0007, task0008, task0009 | TS-4, TS-10, TS-11, TS-12 |
| FR6 | task0001, task0002 | TS-5, TS-8 |
| NFR1 | task0005 | TS-6 |
| NFR2 | task0003, task0005, task0010 | TS-4, TS-7, TS-13 |
...
- [ ] M-4: Resize the app window with the overlay open → the card follows
      ...
      still scrolls the terminal

## Verification Summary
| Category | Items | Automated | E2E | Manual |
|----------|-------|-----------|-----|--------|
| Build | 2 | 2 | 0 | 0 |
| Unit/Integration | TS-1..TS-13 | 13 | 0 | 0 |
