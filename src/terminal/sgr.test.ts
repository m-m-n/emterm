  ...
  describe("Combined parameters", () => {
    ...
    it("should parse complex sequence with RGB", () => {
      expect(parseSgrParams([1, 3, 38, 2, 255, 0, 128])).toEqual([
        { attr: "Bold" },
        { attr: "Italic" },
        { attr: "Foreground", value: { type: "Rgb", value: { r: 255, g: 0, b: 128 } } },
      ]);
    });
  });
