...
describe("TerminalState", () => {
  ...
  describe("processAction - Print", () => {
    ...
    test("scrolls when printing at bottom right corner", () => {
      ...
      for (let i = 0; i < 5; i++) {
        state.processAction({ type: "Print", value: String.fromCharCode(70 + i) });
      }
      // Now on row 2
      for (let i = 0; i < 5; i++) {
        state.processAction({ type: "Print", value: String.fromCharCode(75 + i) });
      }
  ...
  describe("multiple characters", () => {
    ...
    test("handles CR LF sequence", () => {
      ...
      expect(state.getActiveBuffer().getLine(0).getText().startsWith("Line1")).toBe(true);
      expect(state.getActiveBuffer().getLine(1).getText().startsWith("Line2")).toBe(true);
      expect(state.cursorRow).toBe(1);
      expect(state.cursorCol).toBe(5);
    });
  });
  ...
  describe("processAction - CSI cursor movement", () => {
    test("CursorUp moves cursor up", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 10, col: 10 } } });
      state.processAction({ type: "Csi", value: { action: "CursorUp", data: 3 } });
    ...
    test("CursorDown moves cursor down", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorDown", data: 5 } });
    ...
    test("CursorForward moves cursor right", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorForward", data: 10 } });
    ...
    test("CursorBack moves cursor left", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 1, col: 20 } } });
      state.processAction({ type: "Csi", value: { action: "CursorBack", data: 5 } });
    ...
    test("CursorNextLine moves cursor down and to column 1", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 5, col: 20 } } });
      state.processAction({ type: "Csi", value: { action: "CursorNextLine", data: 3 } });
    ...
    test("CursorPreviousLine moves cursor up and to column 1", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPreviousLine", data: 2 } });
    ...
    test("CursorHorizontalAbsolute sets column", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 10, col: 20 } } });
      state.processAction({ type: "Csi", value: { action: "CursorHorizontalAbsolute", data: 35 } });
    ...
    test("CursorVerticalAbsolute sets row", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 10, col: 20 } } });
      state.processAction({ type: "Csi", value: { action: "CursorVerticalAbsolute", data: 15 } });
    ...
    test("CursorPosition sets absolute position", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 15, col: 30 } } });
  ...
  describe("processAction - CSI erase operations", () => {
    test("EraseInDisplay Below clears from cursor to end", () => {
      ...
      for (let row = 0; row < 5; row++) {
        state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: row + 1, col: 1 } } });
        for (let i = 0; i < 10; i++) {
          state.processAction({ type: "Print", value: "X" });
        }
      }
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 3, col: 6 } } });
      state.processAction({ type: "Csi", value: { action: "EraseInDisplay", data: "Below" } });
    ...
    test("EraseInDisplay All clears entire screen", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "EraseInDisplay", data: "All" } });
    ...
    test("EraseCharacters erases without shifting", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 1, col: 4 } } });
      state.processAction({ type: "Csi", value: { action: "EraseCharacters", data: 3 } });
  ...
  describe("processAction - CSI insert/delete", () => {
    test("InsertLines inserts blank lines", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "InsertLines", data: 1 } });
    ...
    test("DeleteLines deletes lines", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 2, col: 1 } } });
      state.processAction({ type: "Csi", value: { action: "DeleteLines", data: 1 } });
    ...
    test("InsertCharacters inserts blank characters", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 1, col: 4 } } });
      state.processAction({ type: "Csi", value: { action: "InsertCharacters", data: 2 } });
    ...
    test("DeleteCharacters deletes characters", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 1, col: 4 } } });
      state.processAction({ type: "Csi", value: { action: "DeleteCharacters", data: 2 } });
  ...
  describe("processAction - CSI scroll", () => {
    test("ScrollUp scrolls buffer up", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "ScrollUp", data: 1 } });
    ...
    test("ScrollDown scrolls buffer down", () => {
      ...
      state.processAction({ type: "Csi", value: { action: "ScrollDown", data: 1 } });
    ...
    test("SetScrollRegion sets scroll region and moves cursor home", () => {
      const state = new TerminalState(80, 24);
      state.processAction({ type: "Csi", value: { action: "CursorPosition", data: { row: 10, col: 20 } } });
      state.processAction({ type: "Csi", value: { action: "SetScrollRegion", data: { top: 5, bottom: 20 } } });
