...
import { createDefaultAttributes, cloneAttributes } from "./attributes.ts";
...
describe("Performance Optimization Patterns", () => {
  test("should minimize attribute comparisons", () => {
    ...
    const attrs1 = createAttrs({ bold: true, fg: { type: "rgb", r: 255, g: 0, b: 0 } });
    const attrs2 = createAttrs({ bold: true, fg: { type: "rgb", r: 255, g: 0, b: 0 } });
