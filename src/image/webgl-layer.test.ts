...
describe("WebGLLayer", () => {
  describe("isWebGLSupported", () => {
    ...
    test("returns false when WebGL is not available", () => {
      ...
      globalThis.document = { createElement: originalCreate } as unknown as Document;
    });
  });
  ...
  describe("render", () => {
    ...
    test("sorts placements by z-index", () => {
      ...
      layer.addPlacement({ textureId: 1, x: 0, y: 0, width: 100, height: 100, zIndex: 1 });
      layer.addPlacement({ textureId: 2, x: 0, y: 0, width: 100, height: 100, zIndex: -1 });
  ...
  describe("clearPlacements", () => {
    test("removes all placements", () => {
      ...
      layer.addPlacement({ textureId: 1, x: 0, y: 0, width: 100, height: 100, zIndex: 0 });
      layer.addPlacement({ textureId: 2, x: 0, y: 0, width: 100, height: 100, zIndex: 0 });
