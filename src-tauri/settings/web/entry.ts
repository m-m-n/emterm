...
import { SettingsPanel } from "../../web-shared/settings/settings-panel.ts";
import { SettingsService } from "../../web-shared/settings/settings-service.ts";
import { applyUiTheme } from "../../web-shared/settings/settings-applier.ts";
import type { AppSettings } from "../../web-shared/settings/types.ts";
import { initI18n, resolveLocale } from "../../web-shared/i18n/index.ts";
import { initPlatform } from "../../web-shared/platform.ts";
