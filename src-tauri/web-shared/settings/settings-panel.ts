...
const CATEGORY_ICONS: Record<string, string> = {
  ...
  keybinds:
    '<svg viewBox="0 0 24 24"><path d="M20 5H4c-1.1 0-1.99.9-1.99 2L2 17c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm-9 3h2v2h-2V8zm0 3h2v2h-2v-2zM8 8h2v2H8V8zm0 3h2v2H8v-2zM5 11h2v2H5v-2zm0-3h2v2H5V8zm3 7H5v-2h3v2zm8 0H9v-2h7v2zm2 0h-2v-2h2v2zm0-3h-2v-2h2v2zm0-3h-2V8h2v2zm2 3h-2v-2h2v2z"/></svg>',
  ...
  "terminal-behavior":
    '<svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v12zM6 10l4 4-4 4 1.4 1.4L12.8 14l-5.4-5.4L6 10z"/></svg>',
  notification:
  ...
  agent:
    '<svg viewBox="0 0 24 24"><path d="M20 9V7c0-1.1-.9-2-2-2h-3c0-1.66-1.34-3-3-3S9 3.34 9 5H6c-1.1 0-2 .9-2 2v2c-1.66 0-3 1.34-3 3s1.34 3 3 3v4c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-4c1.66 0 3-1.34 3-3s-1.34-3-3-3zM7.5 11.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5S9.83 13 9 13s-1.5-.67-1.5-1.5zM16 17H8v-1.5h8V17zm-1-4c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5S15.83 13 15 13z"/></svg>',
  "markdown-viewer":
...
export class SettingsPanel {
  ...
  private get categories(): Category[] {
    return [
      ...
      {
        id: "keybinds",
        label: t("settings.categories.keybinds"),
        enabled: true,
      },
      { id: "mux", label: t("settings.categories.mux"), enabled: true },
      {
        id: "terminal-appearance",
        label: t("settings.categories.terminalAppearance"),
        enabled: true,
      },
      {
        id: "terminal-behavior",
        label: t("settings.categories.terminalBehavior"),
        enabled: true,
      },
      {
        id: "notification",
      ...
      {
        id: "agent",
        label: t("settings.categories.agent"),
        enabled: true,
      },
      {
        id: "markdown-viewer",
        label: t("settings.categories.markdownViewer"),
        enabled: true,
      },
      {
        id: "profiles",
        label: t("settings.categories.profiles"),
        enabled: true,
      },
  ...
  private async saveSetting<K extends keyof AppSettings>(
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent("emterm-settings-changed", { detail: { key } }),
      );
    } catch (error) {
  ...
  private toggleNavCollapsed(): void {
    ...
    const collapseBtn = this.navElement?.querySelector(
      ".settings-nav-collapse-btn",
    );
    if (collapseBtn) {
      collapseBtn.setAttribute(
        "aria-label",
        this.navCollapsed
          ? t("settings.nav.expand")
          : t("settings.nav.collapse"),
      );
    }
